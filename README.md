...
Bot docelowo wykorzystuje zewnętrzne API i modele AI do:
* **STT** (przekształcania mowy na tekst),
* **LLM** (generowania inteligentnej odpowiedzi),
* **TTS** (syntezy mowy i odpowiadania głosem).
